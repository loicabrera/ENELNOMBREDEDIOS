...
const DetalleServicio = () => {
  ...
  const imagenActual = imagenes.length > 0 ? `http://localhost:3000/api/imagenes_servicio/${imagenes[currentImageIdx]?.id_imagenes}` : null;
    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 flex flex-col gap-4">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#cbb4db' }}>{servicio.nombre}</h2>
          <div className="text-gray-700 mb-2">{servicio.descripcion}</div>
          <div className="text-lg font-bold mb-2" style={{ color: '#fbaccb' }}>Precio: ${servicio.precio}</div>
          <div className="mt-6">
